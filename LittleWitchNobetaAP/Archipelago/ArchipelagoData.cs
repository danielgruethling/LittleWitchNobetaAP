...
public static class ArchipelagoData
{
    ...
    public static string GameLocationToDescriptiveLocation (string gameLocation)
    {
        var descriptiveLocation = gameLocation switch
        {
            ...
            "TreasureBox_Room01" => "Underground - Chest Room01",
            // Handled elsewhere because name appears twice
            /*case "TreasureBox_Room03":
                descriptiveLocation = "Underground - Chest Room03";
                break;
            */
            "TreasureBox_Room04" => "Underground - Chest Room04",
            "TreasureBox_Room05_01" => "Underground - Chest Room05_01",
            "TreasureBox_Room05_02" => "Underground - Chest Room05_02",
            "Cat" => "Underground - Cat",
            //underground_tania_locations
            "TreasureBox_Room08" => "Underground - Chest Room08",
            "Boss_Level02" => "Underground - Tania",
            // lava_ruins_start_locations
            "Room02_TreasureBox01" => "Lava Ruins - Chest Room02_01",
            "Room02_TreasureBox02" => "Lava Ruins - Chest Room02_02",
            "Room03_TreasureBox01" => "Lava Ruins - Chest Room03_01",
            "Room03_TreasureBox02" => "Lava Ruins - Chest Room03_02",
            "Room02To04_TreasureBox02" => "Lava Ruins - Chest Room02To04",
            "Room05To06_TreasureBox" => "Lava Ruins - Chest Room05To06",
            "Room06_TreasureBox" => "Lava Ruins - Chest Room06",
            // lava_ruins_after_fire_barrier_locations
            "Room07_TreasureBox" => "Lava Ruins - Chest Room07",
            "Room08_TreasureBox" => "Lava Ruins - Chest Room08",
            "Boss_Level03_Big" => "Lava Ruins - Monica",
            "Room01_TreasureBox" => "Lava Ruins - Chest Room01",
            // dark_tunnel_start_locations
            "TreasureBox02_Room02_03" => "Dark Tunnel - Chest Room02",
            "TreasureBox02_Room03_01" => "Dark Tunnel - Chest Room03_01",
            "TreasureBox02_Room03_02" => "Dark Tunnel - Chest Room03_02",
            "TreasureBox02_Room04" => "Dark Tunnel - Chest Room04",
            "TreasureBox02_Room05" => "Dark Tunnel - Chest Room05",
            // dark_tunnel_after_thunder_locations
            "TreasureBox02_Room06To07" => "Dark Tunnel - Chest Room06To07",
            "TreasureBox02_Room07" => "Dark Tunnel - Chest Room07",
            "TreasureBox02_Room08" => "Dark Tunnel - Chest Room08",
            "TreasureBox02_Room09To10" => "Dark Tunnel - Chest Room09To10",
            "Boss_Level04" => "Dark Tunnel - Vanessa",
            // spirit_realm_start_locations
            "TreasureBox02_R02" => "Spirit Realm - Chest Room02",
            "TreasureBox02_R03" => "Spirit Realm - Chest Room03",
            "TreasureBox02_R0401" => "Spirit Realm - Chest Room04_01",
            // spirit_realm_after_arcane_barrier_locations
            "TreasureBox02_R0402" => "Spirit Realm - Chest Room04_02",
            "TreasureBox02_R06" => "Spirit Realm - Chest Room06",
            "TreasureBox02_R07" => "Spirit Realm - Chest Room07",
            // spirit_realm_after_teleport_locations
            "TreasureBox02_R08" => "Spirit Realm - Chest Room08",
            "Boss_Level05" => "Spirit Realm - Queen Vanessa V2",
            // abyss_locations
            "TreasureBox_Act02Room04" => "Abyss - Chest Room04",
            "TreasureBox_Act02Room05" => "Abyss - Chest Room05",
            // abyss_trials_locations
            "Act04Room05To06_TreasureBox" => "Abyss - Chest Lava Ruins Trial",
            "Act05_TreasureBox02_Room09To10" => "Abyss - Chest Dark Tunnel Trial",
            "Act03TreasureBox_Room05_02" => "Abyss - Chest Underground Trial",
            "Nonota" => "Abyss - Nonota",
            _ => ""
        };
